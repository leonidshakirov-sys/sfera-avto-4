...
export function Access() {
  ...
  return (
    <section id="access" className="relative overflow-hidden py-24">
      <Photo src="/images/access.jpg" alt="Въезд на площадку Сфера Авто, 32-й км МКАД, владение 15" fill className="object-cover object-center" sizes="100vw" />
      ...
      <div className="wrap relative grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        <div>
          ...
          <p className="mt-5 max-w-xl text-lg text-paper/85">
            «Сфера Авто» находится на 32-м км МКАД, владение 15. Площадка подходит владельцам транспорта и компаниям, которым важно иметь удобный доступ к МКАД и не хранить технику далеко от основных маршрутов.
          </p>
